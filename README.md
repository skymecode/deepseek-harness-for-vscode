...
> This is a community-maintained `0.5.9-dev` release. DeepSeek Harness is currently a Developer Preview, and this extension pins the official `@deepseek-ai/dsh@0.1.3-alpha.2` package (Typert Remote protocol).
