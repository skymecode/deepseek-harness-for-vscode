export const ENGLISH_WEBVIEW_MESSAGES = {
  ...
  apiKeyConfigured: 'An API Key is configured.',
  apiKeyNotConfigured: 'No API Key configured yet.',
  openNativeSettings: 'Open full settings',
  apply: 'Apply',
  closeSettings: 'Close settings',
  settingsHint: 'Click Apply to save the changes and restart the runtime.',
  testConnection: 'Test connection',
  testingConnection: 'Testing…',
  connectionSuccess: 'Connection successful. API Key is valid.',
  connectionUnauthorized: 'API Key is invalid or not provided.',
